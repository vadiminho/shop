...
<div class="container main">
  ...
  <form action="/Registration/reg" class="form-control" method="post">
    <input type="text" name="name" value="<?=$_POST['name'] ?>" placeholder="Введите ваше имя"><br>
    <input type="text" name="lastname" value="<?=$_POST['lastname'] ?>" placeholder="Введите вашу фамилию"><br>
